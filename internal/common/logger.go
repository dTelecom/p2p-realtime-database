...
// LoggerAdapter adapts a simpler logger to our Logger interface
type LoggerAdapter struct {
	logger SimpleLogger
}

// NewLoggerAdapter creates a new adapter that wraps a simpler logger
// and makes it compatible with our Logger interface
func NewLoggerAdapter(logger SimpleLogger) Logger {
	return &LoggerAdapter{logger: logger}
}

// Implement all required methods for Logger interface
